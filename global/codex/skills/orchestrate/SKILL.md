---
name: orchestrate
description: Route a complex task to the right converted Codex role skills and summarize how to coordinate their guidance.
...
Codex note: Claude subagents are converted here as `role-*` skills. Use this routing table to decide which role guidance to read or invoke; do not assume a Claude Code subagent runtime is available.
...
| 15 | new project / AGENTS.md missing / init / scaffold | setup / initialise | `init-project` |
