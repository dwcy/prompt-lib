---
name: role-code-cleaner
description: Role skill converted from Claude subagent. Safely removes dead code, dead CSS, unused assets, obsolete files, stale source files, unused dependencies, and redundant project clutter. Use during refactoring, before releases, or when cleaning a messy repository.
