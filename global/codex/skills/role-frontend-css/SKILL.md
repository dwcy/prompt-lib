---
name: role-frontend-css
description: Role skill converted from Claude subagent. CSS architecture specialist for frontend projects. Scaffolds globals.css with reset, CSS custom properties, and theming; generates CSS modules for components; enforces the modular + global pattern with no hardcoded values.
...
Use these unless the project's AGENTS.md defines a different palette. These match the "Neon Curator" dark theme from the global design system.
