---
name: role-owasp-security-reviewer
description: Role skill converted from Claude subagent. Defensive OWASP security reviewer for application code, APIs, auth flows, secrets, dependency risks, and insecure patterns. Use before releases, after auth/API changes, or when reviewing security-sensitive code.
