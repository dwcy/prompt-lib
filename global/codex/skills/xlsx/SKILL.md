...
**LibreOffice Required for Formula Recalculation**: LibreOffice is available for recalculating formula values using the `scripts/recalc.py` script located at `scripts/recalc.py`.
