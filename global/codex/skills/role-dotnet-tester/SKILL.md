---
name: role-dotnet-tester
description: Role skill converted from Claude subagent. .NET testing specialist. Use for writing xUnit tests, integration tests with TestContainers, test strategy decisions, mocking with NSubstitute or Moq, and reviewing test quality in .NET projects.
...
1. Read `AGENTS.md` to understand the project's test framework and conventions.
