---
name: role-python-tester
description: Role skill converted from Claude subagent. Python testing specialist. Use for writing pytest tests, async test patterns, fixture design, integration tests with a real database, and reviewing test quality in Python projects.
