...
Stored at `.agents/skills/self-improvement/memory/`:
...
```bash
python .agents/skills/self-improvement/scripts/extract_lessons.py list [<file>]
# Lists all entry IDs + titles in lessons/mistakes/preferences/evals.

python .agents/skills/self-improvement/scripts/extract_lessons.py remove <file> <id>
# Removes a specific entry by ID. Prints the removed block to stderr so you can paste it back if needed.

python .agents/skills/self-improvement/scripts/extract_lessons.py validate
