...
| Multi-machine setup / deployment | Interactive TUI wizard at `setup/settings-configurator-ui.py` — deploy, init env vars, show inline drift markers, restore from backup, local project scaffold, optional companion tools |
