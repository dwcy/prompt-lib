...
|---|---|
| Domain expertise on demand | 25 specialist subagents (`@dotnet-architect`, `@python-tester`, `@react-architect`, `@tanstack-architect`, `@frontend-css`, `@frontend-designer`, `@ux-analyst`, `@unity-architect`, `@requirements-analyst`, `@api-designer`, `@db-architect`, `@data-analyst`, `@website-content-analyst`, `@git-repo-analyst`, `@code-plan-verifier`, `@gitignore-auditor`, `@secret-auditor`, `@owasp-security-reviewer`, `@init-project`, `@load-project`, …) auto-invoked when the task matches their description |
