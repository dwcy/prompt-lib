...
<!-- SPECKIT START -->
Active spec-kit feature: **010-cabal-tools-polish-part2** - Cabal Tools view polish for richer tool metadata, source links, expanded AI/editor/database/Azure/dev-tool coverage, container-backed database installs, copyable text, runtime backups, and version selectors.
For technical context, structure, stack decisions, and constitution gate status, read [`specs/010-cabal-tools-polish-part2/plan.md`](specs/010-cabal-tools-polish-part2/plan.md). The full design tree is at `specs/010-cabal-tools-polish-part2/` (spec, plan, research, data-model, contracts, quickstart).
