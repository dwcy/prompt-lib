...
`specs/009-headroom-tool/research.md` §B — the investigate-only proxy verdict (FR-009). Required terminal field: **Verdict ∈ {pursue, shelve, reject}**, filled during the implementation spike.
