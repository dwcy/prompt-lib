# -*- coding: utf-8 -*-
"""wizard.py — CABAL Claude Code Setup Wizard (Textual TUI).
...
# textual + rich are declared as install-time deps in pyproject.toml (cabal
...
#   - Source checkout: this file lives at <repo>/setup/src/cabal/wizard.py with
...
def _resource_root() -> Path:
    ...
    if pkg_data.is_dir():
        IS_INSTALLED = True
        return pkg_data
    # source checkout: setup/src/cabal/wizard.py → repo root
